...
export default function FHIRHealthcareService() {
    ...
    useEffect(() => {
        ...
        // get coverage data
        fetch(`${test_url}/api/data/healthcareService`)
            .then(res => {
                return res.json();
            }).then(fhirData => {
                                ...
                                <TabPanel key="display" id="display" tab="Display">
                                    <Table>
                                        ...
                                        <TableRow>
                                            ...
                                            <TableCell>
                                                {record.resource.identifier?.[0].value}
                                            </TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell>
                                            ...
                                            <TableCell>
                                                {record.resource.identifier?.[1].value}
                                            </TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell>
